...
/**
 * Terms and Conditions page displaying the official SLEEK Dental Club terms of service.
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 prose prose-gray max-w-none">
          ...
          <ul>
            ...
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SLEEK Dental Club, 16775 Addison Rd., Suite 612 Addison, TX 75001.</li>
          ...
          <p>
            Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Website and tells You about Your privacy rights and how the law protects You. Please read Our <Link href="/privacy" className="text-teal-600 hover:text-teal-700">Privacy Policy</Link> carefully before using Our Service.
          </p>
          ...
          <ul>
            ...
            <li>By mail: SLEEK Dental Club, 16775 Addison Rd., Suite 612, Addison, TX 75001</li>
          </ul>
        </div>
      </div>
    </main>
